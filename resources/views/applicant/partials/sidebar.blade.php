...
<aside class="sidebar">
    ...
    <div class="nav-item active" data-section="profile">
      <span class="icon">
        ...
        <a href="{{route('applicant.dashboard')}}"> {{ __('Профиль') }} </a>
    </div>
    <div class="nav-item" data-section="employers">
      <span class="icon">
        ...
        <a href="{{route('applicant.responses.index')}}"> {{ __('Отклики компаний') }} </a>
    </div>
    <div class="nav-item" data-section="responses">
      <span class="icon">
        ...
        <a href="{{route('applicant.resume.index')}}"> {{ __('Мое резюме') }} </a>
    </div>
    ...
    <div class="nav-item" data-section="my-responses">
      <span class="icon">
        ...
        <a href="{{route('public.responses.index')}}"> {{ __('Мои отклики') }} </a>
    </div>
    <div class="nav-item" data-section="vacancies">
      <span class="icon">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="7" width="18" height="13" rx="2"/><path d="M9 7V5a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v2"/><path d="M3 12h18"/></svg>
      </span>
    ...
    <div class="nav-item" data-section="calls">
      <span class="icon">
        ...
        <a href="{{route('applicant.calls.index')}}"> {{ __('Звонки') }} </a>
    </div>
    ...
    <div class="nav-item" data-section="complaints">
      <span class="icon">
        ...
        <a href="{{route('applicant.complaints.index')}}"> {{ __('Жалобы') }} </a>
    ...
    <div class="nav-item" data-section="settings">
      <span class="icon">
        ...
        <a href="{{route('applicant.settings.index')}}"> {{ __('Настройки') }} </a>
    </div>

...
<div class="app">
    ...
    <main class="main">
        ...
        <div class="topbar">
            <div>
                <h1 id="pageTitle">{{ __('Жалобы') }}</h1>
                <p id="pageSubtitle">{{ __('Что прислали вам и что отправили вы') }}</p>
            </div>
        ...
        <section class="section active" id="section-complaints">
            @include('partials.complaint-list')
        </section>

                    ...
                    <div class="form-card" style="margin-left: 17vh;">
                        <form action="{{route('employer.vacancies.store')}}" method="post">
                            ...
                            <div class="card-body">
                                ...
                                <div class="field-group split">
                                    <div>
                                        ...
                                        <input type="text" value="{{$employer->company_name}}" style="width: 37vh;">
                            ...
                            <div class="card-foot">
                                ...
                                <button type="submit" class="submit-btn">{{ __('Опубликовать вакансию') }}</button>
                            </div>
                        </form>
                    </div>
                </div>

...
<head>
    ...
    <title>{{ __('Workio — Уведомления') }}</title>
...
<div class="app">
    ...
    <main class="main">
        ...
        <div class="topbar">
            <div>
                <h1 id="pageTitle">{{ __('Уведомления') }}</h1>
                <p id="pageSubtitle">{{ __('Всё, что произошло в вашем кабинете') }}</p>
            </div>
        ...
        <section class="section active" id="section-notifications">

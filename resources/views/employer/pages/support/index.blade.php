...
<head>
    ...
    <title>{{ __('Workio — Администратору') }}</title>
...
<div class="app">
    ...
    <main class="main">
        ...
        <div class="topbar">
            <div>
                <h1 id="pageTitle">{{ __('Администратору') }}</h1>
                <p id="pageSubtitle">{{ __('Вопросы и обращения к администрации площадки') }}</p>
            </div>
        ...
        <section class="section active" id="section-support">
            @include('partials.support-list')
        </section>

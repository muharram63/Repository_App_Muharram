...
<div class="app">
    ...
    <main class="main">
        ...
        <div class="topbar">
            <div>
                <h1 id="pageTitle">{{ __('Звонки') }}</h1>
                <p id="pageSubtitle">{{ __('Входящие, исходящие и пропущенные видеозвонки') }}</p>
            </div>
        ...
        <section class="section active" id="section-calls">
            @include('partials.call-log')
        </section>
